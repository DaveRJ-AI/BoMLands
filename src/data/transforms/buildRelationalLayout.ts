...
const NEW_WORLD_MANUAL_POSITION_OVERRIDES: Record<string, AnchorPosition> = {
  ...
  temple_zarahemla: { x: 927, y: 1108 },
  tower_nephi_garden: { x: 933, y: 1112 },
  tower_benjamin: { x: 929, y: 1097 },
  manti_headwaters: { x: 880, y: 1377 },
  antionum_region: { x: 1131, y: 1240 },
  east_wilderness_zarahemla: { x: 1056, y: 1209 },
  land_first_inheritance: { x: 506, y: 1820 },
  first_landing: { x: 979, y: 2046 },
  temple_bountiful: { x: 868, y: 965 },
  ...
  land_sidom: { x: 905, y: 997 },
  land_siron: { x: 1104, y: 1305 },
  land_minon: { x: 839, y: 1404 },
  land_lehi_nephi: { x: 789, y: 1534 },
  city_lehi_nephi: { x: 777, y: 1553 },
  mount_antipas: { x: 1035, y: 1535 },
  land_shilom: { x: 750, y: 1578 },
  city_shilom: { x: 729, y: 1550 },
  hill_north_of_shilom: { x: 690, y: 1487 },
  hill_onidah: { x: 980, y: 1582 },
  hill_riplah: { x: 998, y: 1219 },
  land_antum: { x: 484, y: 465 },
  hill_shim: { x: 523, y: 511 },
  land_joshua: { x: 602, y: 1299 },
  land_moriantum: { x: 784, y: 481 },
  city_shem: { x: 726, y: 408 },
  city_sidom: { x: 912, y: 1011 },
  city_teancum: { x: 830, y: 571 },
  temple_nephi: { x: 900, y: 1617 },
